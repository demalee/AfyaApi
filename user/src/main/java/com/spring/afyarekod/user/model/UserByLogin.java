...
/**
 * 
 * This table stores the user credentials for authentication and authorization
*/
...
public class UserByLogin implements Serializable {
	...
	public UserKeyLogin getKey() {
		return key;
	}

	public void setKey(UserKeyLogin key) {
		this.key = key;
	}		
